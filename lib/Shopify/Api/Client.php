...
class Client
{
    ...
    /**
     * the permanent access token generated by Shopify
     *
     * @var string
     */
     ...
     * @return \stdClass
     */
    public function post($resource, array $data = array(), array $options = array())
    {
        return $this->makeApiRequest($resource, $data, HttpClient::POST, $options);
    }
     ...
     * @return \stdClass
     */
    public function put($resource, array $data = array(), array $options = array())
    {
        return $this->makeApiRequest($resource, $data, HttpClient::PUT, $options);
    }
     ...
     * @return \stdClass
     */
    public function delete($resource, array $data = array(), array $options = array())
    {
        return $this->makeApiRequest($resource, $data, HttpClient::DELETE, $options);
    }
     ...
     * @param  array   $params
     * @param  string  $method
     * @param  array   $options allow two option ('headers', 'raw')
     *
     * @return \stdClass
     */
    protected function makeApiRequest(
        ...
        switch ($method) {
            case HttpClient::GET:
                $response = $this->getHttpClient()->get($uri, $params, $options);
                break;
        ...
        return in_array('raw', $options) ? $response : json_decode($response);
    }
